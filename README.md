...
Astro-Engine is a small Python application that calculates an astrological chart from a given **date, time, and location**.

Unlike most astrology applications, Astro-Engine focuses on producing **machine-friendly output**.  
All results are returned as structured **JSON**, making the data easy to:

- render in tables or dashboards
- feed into other programs or APIs
- use for research, analysis, or automation

A simple **Streamlit demo interface** is included to showcase how the data can be visualized.

---

## Features

- Precise chart calculations (date, time, location)
- Multiple house systems (Placidus, Regiomontanus, Whole Sign, etc.)
- Strongly-typed internal data model
- JSON output suitable for programmatic use
- Example script for programmatic usage
- Streamlit demo UI for exploration
